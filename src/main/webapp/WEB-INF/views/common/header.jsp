                    ...
                    <li class="pull-right">
                        <ul class="list-inline icon-position">
                            <li>
                                ...
                                <label class="hidden-xs"><a href="resources/mailto:" class="text-white">info@EAT.com</a></label>
                            </li>
                            <li>
        ...
        <nav class="navbar navbar-default container">
            ...
            <div class="collapse navbar-collapse" id="collapse">
                <ul class="nav navbar-nav navbar-right">
                    <li><a href="resources/index.html"> Home</a>
                    </li>
                    <li class="dropdown"><a href="resources/#" class="dropdown-toggle" data-toggle="dropdown"> Features</a>
                        <ul class="dropdown-menu" role="menu">
                            <li><a href="resources/typography.html">Typography</a>
                            </li>
                            <li><a href="resources/advancedfeatures.html">Advanced Features</a>
                            </li>
                            <li><a href="resources/grid.html">Grid System</a>
                            </li>
                        </ul>
                    </li>
